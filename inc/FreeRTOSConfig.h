...
/**
 * Store the stack address in the task contaxt. Useful for debugging.
*/
 ...
 *     its priority manually set to a value that is numerically equal to or greater 
 *     than the configMAX_SYSCALL_INTERRUPT_PRIORITY
 * 
